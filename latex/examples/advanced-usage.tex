...
\newfontfamily\nepalikalimati[
  Path=../../fonts/sources/kalimati/,
  Extension=.ttf,
  UprightFont=kalimati,
  BoldFont=kalimati,
  ItalicFont=kalimati,
  Script=Devanagari,
  Language=Nepali
...
Noto Sans Devanagari (primary), Noto Serif Devanagari, Mukta, Kalimati.
...
{\nepalimukta\textnepali{Mukta: खुला आकार र आधुनिक दृश्य लय।}}\\[0.4em]
{\nepalikalimati\textnepali{Kalimati: परम्परागत नेपाली टाइपोग्राफी शैली।}}
